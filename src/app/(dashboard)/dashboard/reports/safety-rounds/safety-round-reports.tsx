...
import { SAFETY_ROUND_STATUSES, getStatusBadgeVariant } from "@/lib/constants/safety-round-statuses"
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <div className="text-sm text-muted-foreground">
                      Gjennomført {report.completedAt ? formatDate(report.completedAt) : 'Ikke gjennomført'}
                    </div>
                  </div>
                  <Link href={`/dashboard/reports/safety-rounds/${report.id}`}>
